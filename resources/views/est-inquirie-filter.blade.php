...
<div class="form-element-area">
	...
	<div class="breadcomb-area">
		<div class="container">
            ...
            <form action="{{url('est-inquirie-filter')}}" method="get" enctype="multipart/form-data">
                ...
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                  ...
                  <div class="form-group nk-datapk-ctm form-elet-mg" id="data_1">
                    <div class="input-group date nk-int-st">
                      ...
                      <input type="text" class="form-control" name="date_from" value="<?php if(!empty($date_from)){echo $date_from; } ?>" />
                    </div>
                  </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                  ...
                  <div class="form-group nk-datapk-ctm form-elet-mg" id="data_1">
                    <div class="input-group date nk-int-st">
                      <span class="input-group-addon"></span>
                      <input type="text" class="form-control" name="date_to" value="<?php if(!empty($date_to)){echo $date_to; } ?>" />
                    </div>
                  </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <div class="data-table-list">
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                  <?php $i = 1; if(!empty($est_inquiry_filter_date)){foreach($est_inquiry_filter_date as $key=>$value){ if(!empty($date_from) AND date("m-d-Y", strtotime($value->date))>=$date_from AND !empty($date_to) AND date("m-d-Y", strtotime($value->date))<=$date_to){; ?>
                                  <tr>
                                    <td><?php echo $i; ?></td>
