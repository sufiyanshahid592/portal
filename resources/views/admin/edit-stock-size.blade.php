...
<div class="form-element-area">
	...
	<div class="breadcomb-area">
		<div class="container">
            ...
            <form action="{{url('edit-stock-size-process')}}" method="post">
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
              <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                  <label class="nk-label">Enter Stock Size:</label>
                  <div class="form-group nk-datapk-ctm form-elet-mg" id="data_1">
                    <div class="input-group nk-int-st">
                      <span class="input-group-addon"></span>
                      <input type="text" class="form-control" name="stock_size_value" value="<?php if(!empty($get_stock_size_by_id)){echo $get_stock_size_by_id[0]->stock_size_value; } ?>" />
                    </div>
                  </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                  ...
                  <div class="form-example-int">
                    <input type="hidden" name="stock_size_id" value="{{$get_stock_size_by_id[0]->stock_size_id}}">
