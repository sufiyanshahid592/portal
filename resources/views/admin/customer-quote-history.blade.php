    			...
    			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    				<div class="data-table-list">
    					<div class="table-responsive">
    						<div id="data-table-basic_wrapper" class="dataTables_wrapper no-footer">
    							<table id="data-table-basic" class="table table-striped dataTable no-footer">
    								<thead>
                                ...
                                <tbody>
                                	<?php foreach($sales_enquires_by_sudo_name as $value){ ?>
                                	<tr>
                                		<td>{{$value->id}}</td>
                                        ...
                                        <td>{{$value->c_email}}</td>
                                          ...
                                          <td><button type="button" data-id="{{$value->id}}" class="btn btn-success notika-btn-success get-product-info-view">Products Info</button></td>
                                          <td>
