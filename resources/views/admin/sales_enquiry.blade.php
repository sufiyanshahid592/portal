            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-element-list mg-t-30">
                     ...
                     <div class="row" style="padding-bottom:10px;">  
                           <div class="col-lg-7">
                        <div class="cmp-tb-hd">
                        <h2 style="text-align:right;">Add Enquiry  </h2>
                        ...
                        <div class="col-lg-5" >
                            <ul>
                                <li style="display: inline-block;">
                                     <label class=""><div style="position: relative;"><input type="radio" class="i-checks" name="customer_relation" style="position: absolute; opacity: 0;" value="1" checked ><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins><i></i> New Customer</div> </label>
                        
                                </li>
                                <li style="display: inline-block;">
                                     <label class=""><div style="position: relative;"><input type="radio" class="i-checks" name="customer_relation" style="position: absolute; opacity: 0;" value="0"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins><i></i> Repeat Customer</div> </label>
 ...
 <input type="hidden" value="<?php echo Session::get('user_id_login'); ?>" name="username">
  <input type="hidden" value="<?php echo Session::get('user_name_login'); ?>" name="sudoname">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                         ...
                         <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <select class="selectpicker" name="website" data-live-search="true">
                                   ...
                                   <option value="14">thecustomboxes.com</option>
                                    @foreach($website as $web)
                                    <option value="{{$web->web_id}}">{{$web->website}}</option>
                                   @endforeach
                                    </select>
                            </div>
                              </div> 
                 ...
                 <div class="row" style="margin-bottom:30px;" >
                            ...
                            <div class="form-group ic-cmp-int float-lb form-elet-mg">
                                <div class="form-ic-cmp">
                                    ...
                                    <label class="nk-label">Product *</label>
                                            ...
                                            <a href="javascript:void(0);" style="position: absolute; right: 0; top: 0;" class="add_button_print_p" title="Add field" product-count="1"><img src="{{url('images/add-icon.png')}}"/></a>
                                </div>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            ...
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="f_s_1[]" />
                           ...
                           <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="f_s_2[]" />
                          ...
                          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="f_s_3[]" />
                         ...
                         <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            ...
                            <div class="bootstrap-select fm-cmp-mg" style="padding: 3px;">
                                <select class="selectpicker" name="measurement[]" data-live-search="true">
                    ...
                    <div class="row">
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="open_size_1[]" required/>
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="open_size_2[]" />
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 sales-inquiry-qty-product-1">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="form-group ic-cmp-int float-lb floating-lb sales-inquiry-qty-row">
                                <div class="form-ic-cmp">
                                </div>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="qty[1][1]" required/>
                                    <label class="nk-label">Quantity *</label>
                                    <a href="javascript:void(0);" style="position: absolute; right: 0; top: 0;" class="add_button_sales_inquiry_qty" title="Add field" product-count="1"><img src="{{url('images/add-icon.png')}}"/></a>
                                    <input type="hidden" name="product_numbers[]" value="1">
                                </div>
                            </div>
                        </div>
                           <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="price[1][1]" />
                      ...
                      <div class="row">
                            ...
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                            <div class="nk-int-st">
                                <input type="text" class="form-control addons" name="addons[]"  />
                        ...
                        <div class="col-lg-4">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                            <div class="nk-int-st">
                                <input type="text" class="form-control usa_upping" name="usa_upping[]"  />
                        ...
                        <div class="col-lg-4">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="product_coment[]" />
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    ...
                                    <?php } else if($value->inq_status==0){?>
                                     ...
                                     <td>
                                        <button style="  
     background-color: #00c292;border: 1px solid #00c292;" class="btn btn-primary">Sent to the EST</button>
                                    </td>
                                    <?php } else if($value->price_offerd_by_sales_manager_status== 0){?>
                                    <td>
                                        <button style="  
     background-color: #00c292;border: 1px solid #00c292;" class="btn btn-primary">Waiting for SM Aproval </button>
                                    </td>
                                    
                                    <?php }  else if($value->price_offerd_by_sales_manager_status== 1){?>
                                    <td class="sent-price-quote-btn-<?php echo $value->id; ?>">
                                        <?php if($value->price_quote_send_by_email==1){ ?>
                                            <button style=" width: 100%;
     background-color: #00c292;border: 1px solid #00c292;" class="btn btn-primary" data-toggle="modal">
  Price Sent
</button>
                                        <?php }else{ ?>
  ...
  <div class="modal-dialog" role="document"  >
    ...
    <div class="modal-content" id="container_content">
     ...
     background-color: #00c292;border: 1px solid #00c292;"  class="btn btn-primary"> Req for Time Increment  <span ></span> </button>
                       ...
                       <?php   } ?>
                       <?php if($value->price_offerd_by_sales_manager_status!= 1){ ?>
                       <option value="upr" data-id="{{$value->id}}">Urgent Price Request</option>
                    <?php } ?>
                                    </select>
  ...
  if(this.value=="est"){
   ...
   $(document).on("click", ".follow-view-close", function(){
      ...
      $(document).on("click", ".send-follow-email", function(){
        ...
        var follow_inquiry_content = $(".follow-inquiry-content").val();
      ...
      /*$(document).on("keyup", ".follow-inquiry-content", function(){
