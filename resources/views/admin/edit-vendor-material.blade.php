...
<form id="basic-form" method="post" action="{{url('edit-vendor-material-process')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <select type="text" class="selectpicker" name="vendor_material_for" required>
                                        <option value="">-- Select Vendor Material Parent --</option>
                                        <option <?php if($get_vendor_material_by_id[0]->vendor_material_for==1){echo "selected";} ?> value="1">Die Making</option>
                                        <option <?php if($get_vendor_material_by_id[0]->vendor_material_for==2){echo "selected";} ?> value="2">Die Cuting</option>
                                        <option <?php if($get_vendor_material_by_id[0]->vendor_material_for==3){echo "selected";} ?> value="3">Pasting</option>
                                    </select>
                                    <label class="nk-label">Vendor Material For *</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="vendor_material_value" value="<?php echo $get_vendor_material_by_id[0]->vendor_material_value; ?>" required/>
                                    <label class="nk-label">Vendor Material Value *</label>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="Table-view">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                   <div class="form-example-int">
                                        <input type="hidden" name="vendor_material_id" value="<?php echo $get_vendor_material_by_id[0]->vendor_material_id; ?>">
