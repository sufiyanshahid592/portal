...
<form id="basic-form" method="post" action="{{url('add-new-vendor-material-process')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <select type="text" class="selectpicker" name="vendor_material_for" required>
                                        ...
                                        <option value="1">Die Making</option>
                                        <option value="2">Die Cuting</option>
                                        <option value="3">Pasting</option>
                                    </select>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="vendor_material_value"  required/>
