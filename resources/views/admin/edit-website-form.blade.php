  ...
  <style>
            ...
            @keyframes shrink {
                ...
                100% {
                    ...
                    @if(Session::has('WebsiteUpdate'))
                    
                    <center>
                    
                    <div  class='alert alert-success'> {{ Session::get('WebsiteUpdate') }}</div>
                    </center>
                    
                    @endif
<div class="form-element-area">
<form id="basic-form" method="post" action="{{url('update-website-form'.'/'.$value[0]->web_id)}}" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-element-list mg-t-30">
                    <div class="cmp-tb-hd">
                        <h2 style="text-align:center;">Edit Website </h2>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="website" value="{{$value[0]->website}}"   />
                           ...
                           <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="email" class="form-control" name="email" value="{{$value[0]->email}}"   />
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="address"  value="{{$value[0]->address}}" />
                   ...
                   <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="number"  value="{{$value[0]->number}}" />
                            ...
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="file" class="form-control" name="image"  />
                                      ...
                                      <input type="hidden" class="form-control" name="oldimage" value="{{$value[0]->image}}"  />
                                </div>
                                
                                  <div>
                                      <br>
                                      <br>
                     <img style="" src="{{url('images/'.$value[0]->image)}}">
                  </div>
                  ...
                  <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                   <div class="form-example-int">
                                        <button type="submit" name="submit" style="width:170px;" class="btn btn-success notika-btn-success px-sm-4">Update</button>
                                    </div>
                                </div>
