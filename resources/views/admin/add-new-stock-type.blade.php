...
<div class="form-element-area">
	...
	<div class="breadcomb-area">
		<div class="container">
            ...
            <form action="{{url('add-new-stock-type-process')}}" method="post">
                ...
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                  ...
                  <div class="form-group nk-datapk-ctm form-elet-mg" id="data_1">
                    <div class="input-group nk-int-st">
                      ...
                      <input type="text" class="form-control" name="stock_type_value" />
                    </div>
                  </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                  ...
                  <div class="form-example-int">
                    <button type="submit" style="width:170px;" class="btn btn-success notika-btn-success px-sm-4">Add New</button>
                  </div>
                </div>
              </div>
            </form>
