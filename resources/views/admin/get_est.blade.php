...
.bor-rad::after{
  ...
  @if(Session::has('est_data'))
                    
                    <center>
                    
                    <div  class='alert alert-success'> {{ Session::get('est_data') }}</div>
                    </center>
                    ...
                    <div class="card estimation">
                     ...
                     <td><?php echo date('Y, F j',strtotime($dd->date));?></td>
                             ...
                             <div class="card-p">
                                 <div class="">
                                    <p class="mb-2">
                                        <i class="fas fa-user"></i>  <a href="{{url('est_ticket'.'/'.$dd->id)}}">Send </a> <span class="dark-span">By</span> <a href="{{url('est_ticket'.'/'.$dd->id)}}">{{$dd->csr_sudo_name}}</a>
                                    </p>
                                 </div>
                             </div>
                         </div>
