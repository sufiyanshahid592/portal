...
<form id="basic-form" method="post" action="{{url('edit-product-size-for-plate-making-process')}}" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-element-list mg-t-30">
                    <div class="cmp-tb-hd">
                        <h2>Add New Product Size For Plate Making</h2>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="product_size" value="<?php if(!empty($get_product_size_by_id[0]->product_size)){echo $get_product_size_by_id[0]->product_size;} ?>" required/>
                                    <label class="nk-label">Product Size *</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group ic-cmp-int float-lb floating-lb">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="product_price" value="<?php if(!empty($get_product_size_by_id[0]->product_price)){echo $get_product_size_by_id[0]->product_price;} ?>" required/>
                                    <label class="nk-label">Product Price *</label>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="Table-view">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                   <div class="form-example-int">
                                        <input type="hidden" name="product_size_id" value="<?php if(!empty($get_product_size_by_id[0]->product_size_id)){echo $get_product_size_by_id[0]->product_size_id;} ?>">
